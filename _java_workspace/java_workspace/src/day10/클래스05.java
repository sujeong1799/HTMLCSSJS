...
public class 클래스05 {
	...
	public static void main(String[] args) {
		 ...
		 * static이 안붙은 멤버 변수/메서드들은 객체(인스턴스) 멤버변수/메서드라고 한다.
		 * 
		...
		TV.printBrand(); // 클래스가 다르기때문에 TV를 꼭 붙여야한다.
	}
...
class TV{
	...
	public final static String brand = "Samsung";// 무조건 삼성을 달고 나옴. // final을 붙이면 상수가 됨 수정 불가능.
	...
	public static void printBrand() {
		...
		//클래스 메서드에 객체 변수 사용 불가능.
//		System.out.println(power); // 불가능! 파워는 객체(인스턴스) 멤버라서 못 씀
